...
class CompetencyStandardAdapter(val context: Context, val data: MutableList<CompetencyStandard>): BaseAdapter() {
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        item.setOnClickListener {
            val intent = Intent(context, AssessmentStudentActivity::class.java)

...
class StandardActivity : AppCompatActivity() {
    ...
    lateinit var standardAdapter: StandardAdapter
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val back: ImageView = findViewById(R.id.back_standard)
            ...
            override fun onResponse(
                ...
                if (response.isSuccessful)
                {
                    ...
                    if (body != null)
                    {
                        ...
                        standardAdapter = StandardAdapter(applicationContext, competencyModel)
